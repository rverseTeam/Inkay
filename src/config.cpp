    ...
    switch (language) {
        ...
        default:
            return {
                ...
                .connect_to_network_setting = "Connect to rverse",
        ...
        case nn::swkbd::LanguageType::Spanish:
            return {
                ...
                .connect_to_network_setting = "Conectar a rverse",
        ...
        case nn::swkbd::LanguageType::French:
            return {
                ...
                .connect_to_network_setting = "Connexion à rverse",
        ...
        case nn::swkbd::LanguageType::Italian:
            return {
                ...
                .connect_to_network_setting = "Connettiti alla rete rverse",
        ...
        case nn::swkbd::LanguageType::German:
            return {
                ...
                .connect_to_network_setting = "Verbinde zum rverse",
